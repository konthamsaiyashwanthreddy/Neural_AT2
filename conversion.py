#	Function to convert inches to centimeters def inches_to_centimeters(height_in_inches):
...
#	Convert heights to centimeters using nested loop heights_centimeters = []

for height_in_inches in heights_inches:

height_in_cm = inches_to_centimeters(height_in_inches) heights_centimeters.append(height_in_cm)
...
#	Example using Nested Interactive Loop print("Using Nested Interactive Loop:") heights_nested_loop = convert_heights_nested_loop() print("Heights in Centimeters:", heights_nested_loop)
...
print("Heights in Centimeters:", heights_list_
comprehension)
